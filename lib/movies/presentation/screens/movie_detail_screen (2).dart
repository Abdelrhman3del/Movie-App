...
class MovieDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      lazy: false,
      create: (context) => sl<DetailsMovieBloc>()
...
class MovieDetailContent extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return BlocBuilder<DetailsMovieBloc, MovieDetailsState>(
      builder: (context, state) {
        switch (state.detailsRequestState) {
                    ...
                    background: FadeIn(
                      ...
                      child: ShaderMask(
                        ...
                        child: CachedNetworkImage(
                          ...
                          imageUrl:
                              ApiConstant.imageUrl(state.details!.backdropPath),
                          fit: BoxFit.cover,
                        ),
                      ),
                    ),
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              Container(
                                ...
                                child: Text(
                                  state.details!.relaseDate.split('-')[0],
                              ...
                              const SizedBox(width: 16.0),
                              Text(
                                _showDuration(state.details!.runtime),
                                style: const TextStyle(
                          ...
                          const SizedBox(height: 8.0),
                          Text(
                            'Genres: ${_showGenres(state.details!.genres)}',
                            style: const TextStyle(
                              color: Colors.white70,
                              fontSize: 12.0,
                              fontWeight: FontWeight.w500,
          ...
          case RequestState.error:
            return Center(
              child: Text(state.messageDetails),
            );
        }
      },
    );
