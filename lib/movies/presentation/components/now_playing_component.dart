...
import 'package:movies_app/movies/presentation/screens/movie_detail_screen%20(2).dart';
              ...
              child: CarouselSlider(
                ...
                items: state.nowPlaying.map(
                    ...
                    return GestureDetector(
                      ...
                      onTap: () async{
await Navigator.push(context, MaterialPageRoute(builder: (context)=> MovieDetailScreen(id: item.id)));                      },
                      child: Stack(
                        children: [
                          ShaderMask(
                            shaderCallback: (rect) {
